...
# price_elasticity_project documentation build
...
from price_elasticity_project import __version__ as release

# -- Project information -----------------------------------------------------

project = "price_elasticity_project"
author = "Kedro"
...
htmlhelp_basename = "price_elasticity_projectdoc"
...
latex_documents = [
    (
        master_doc,
        "price_elasticity_project.tex",
        "price_elasticity_project Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "price_elasticity_project",
        "Project price_elasticity_project codebase.",
        "Nearest-Neighbour",
    )
]
